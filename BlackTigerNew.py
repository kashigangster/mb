...
name = raw_input ("\033[91mHelo frends Chenal Subscribe plzz. WhatsApp.Num.03094161457.Type》(lovehacker) : ")																	
...
if password == ("03094161457"):																	
     ...
     time.sleep(0.8)																	
     print 'INGAT ' + name + ' My WhatsApp Number 03094161457 '																	
     time.sleep(0.8)																	
     print 'Ya Command New version ha 1.12'																	
     time.sleep(0.8)																	
     print 'lovehacker ' + name + ' Agar Facebook  tools Galat ho gaya  <https://m.youtube.com/channel/UCRrRgcJjsnNm5Bi5ZenRGnw>'																	
     time.sleep(0.8)																	
     print '[*]●●●●●●●●●●●●● ' + name + ' [~]●●●●●●●●●●●●●/●●●●●●●●●●●●●●●●●●●●●●●..!!'																	
     time.sleep(1.2)																	
